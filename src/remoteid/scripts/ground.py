...
def ground():
    ...
    rospy.init_node('Observador')

    rospy.Subscriber("drone_info_encoded", Drone_data_encoded, callback)
    rospy.Subscriber("drone2_info_encoded", Drone_data_encoded, callback)
    rospy.Subscriber("drone3_info_encoded", Drone_data_encoded, callback)
